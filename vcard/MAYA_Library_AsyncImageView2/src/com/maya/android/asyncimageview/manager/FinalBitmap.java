...
import com.maya.android.asyncimageview.bitmap.core.BitmapProcess;
import com.maya.android.asyncimageview.display.AsyncImageViewDisplayer;
...
public class FinalBitmap {
	...
	private FinalBitmap(Context context) {
		...
		configDisplayer(new AsyncImageViewDisplayer());//配置显示器
	...
	private void doDisplay(View imageView, String uri, BitmapDisplayConfig displayConfig) {
		...
		if (bitmap != null) {
			...
			if(imageView instanceof ImageView){
				...
				if(imageView instanceof AsyncImageView){
					ImageLoadListener listener = ((AsyncImageView)imageView).getImageLoadListener();
					if(Helper.isNotNull(listener)){
						listener.imageLoading();
					}
				}
			}else{
