$(function(){
	...
	$(".returnGoods").live("click",function(){
		var fdOrderId=$(this).attr("fdOrderId");
		indexConfig.returnGoods(fdOrderId);
	});
});
...
var indexConfig={
	...
	returnGoods:function(fdOrderId){//确定收货
		window.location.href=hxltUrl+"wx/returnGoods?fdShopNo="+fdShopNo+"&fdOrderId="+fdOrderId;
	},
