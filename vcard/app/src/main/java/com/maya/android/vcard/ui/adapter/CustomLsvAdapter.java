 ...
 */
public class CustomLsvAdapter extends BaseAdapter{
    private Context mContext;
    private int mCurrentPosition = 0;
    private ArrayList<String> mCustoms = new  ArrayList<String>();
    private ArrayList<Integer> mUnEnablePositionList = null;
    public CustomLsvAdapter(Context mContext){
    ...
    public String getItem(int position) {
        String mTestName = this.mCustoms.get(position);
        if(Helper.isNotNull(mTestName)){
            return mTestName;
        }
        return null;
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        mHodler.mTxvName.setText(this.getItem(position));
        if(this.isShowRadio){
