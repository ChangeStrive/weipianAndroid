...
//	private ImageView dialog_marBottom;
	...
	public XbAlertDialog(Context context) {
		this.context = context;
		WindowManager windowManager = (WindowManager) context.getSystemService(Context.WINDOW_SERVICE);
		display = windowManager.getDefaultDisplay();
	}

	public XbAlertDialog builder() {
		// 获取Dialog布局
//		View view = LayoutInflater.from(context).inflate(
//				R.layout.toast_view_alertdialog, null);
//		View view = LayoutInflater.from(context).inflate(MResource.getIdByName(context, "layout", "toast_view_alertdialog"), null);
		View view = LayoutInflater.from(context).inflate(R.layout.toast_view_alertdialog, null);
		// 获取自定义Dialog布局中的控件
//		lLayout_bg = (LinearLayout) view.findViewById(MResource.getIdByName(context, "id", "lLayout_bg"));
		lLayout_bg = (LinearLayout) view.findViewById(R.id.lLayout_bg);
//		txt_title = (TextView) view.findViewById(MResource.getIdByName(context, "id", "txt_title"));
...
//		dialog_marBottom = (ImageView) view.findViewById(R.id.dialog_marBottom);
		...
		// 调整dialog背景大小
		lLayout_bg.setLayoutParams(new FrameLayout.LayoutParams((int) (ActivityHelper.getScreenWidth() * 0.85), LayoutParams.WRAP_CONTENT));

		return this;
	}

	public XbAlertDialog setTitle(String title) {
		showTitle = true;
		if ("".equals(title)) {
	...
	public XbAlertDialog setEditText(String msg) {
		showEditText = true;
		if ("".equals(msg)) {
	...
	public XbAlertDialog setMsg(String msg) {
		showMsg = true;
		if ("".equals(msg)) {
			txt_msg.setText("内容");
		} else {
	...
	public XbAlertDialog setView(View view) {
		showLayout = true;
		if (view == null) {
			showLayout = false;
		} else
	...
	public XbAlertDialog setCancelable(boolean cancel) {
		dialog.setCancelable(cancel);
		return this;
	}

	public XbAlertDialog setPositiveButton(String text,
	...
	public XbAlertDialog setNegativeButton(String text,
			final OnClickListener listener) {
		showNegBtn = true;
		if ("".equals(text)) {
			btn_neg.setText("取消");
