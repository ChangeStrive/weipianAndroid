...
import com.maya.android.vcard.BuildConfig;
...
public class PinnedSectionListView extends ListView {
    ...
    public void initShadow(boolean visible) {
        if (visible) {
            if (this.mShadowDrawable == null) {
                this.mShadowDrawable = new GradientDrawable(Orientation.TOP_BOTTOM,
                        new int[] { Color.parseColor("#ffa0a0a0"), Color.parseColor("#50a0a0a0"), Color.parseColor("#00a0a0a0")});
                this.mShadowHeight = (int) (8 * getResources().getDisplayMetrics().density);
            }
        } else {
            if (this.mShadowDrawable != null) {
	...
	void destroyPinnedShadow() {
	    if (this.mPinnedSection != null) {
            ...
            this.mRecycleSection = mPinnedSection;
    ...
    void ensureShadowForPosition(int sectionPosition, int firstVisibleItem, int visibleItemCount) {
        ...
        if (this.mPinnedSection != null
                && this.mPinnedSection.position != sectionPosition) { // invalidate shadow, if required
            destroyPinnedShadow();
        }

        if (this.mPinnedSection == null) { // create shadow, if empty
        ...
        if (nextPosition < getCount()) {
            ...
            if (nextSectionPosition > -1) {
                ...
                final int bottom = this.mPinnedSection.view.getBottom() + getPaddingTop();
	...
	public void setAdapter(ListAdapter adapter) {
		...
		if (oldAdapter != null) oldAdapter.unregisterDataSetObserver(this.mDataSetObserver);
		if (adapter != null) adapter.registerDataSetObserver(this.mDataSetObserver);
	...
	protected void dispatchDraw(Canvas canvas) {
		...
		if (this.mPinnedSection != null) {
			...
			int clipHeight = view.getHeight() +
			        (this.mShadowDrawable == null ? 0 : Math.min(this.mShadowHeight, this.mSectionsDistanceY));
			canvas.clipRect(pLeft, pTop, pLeft + view.getWidth(), pTop + clipHeight);

			canvas.translate(pLeft, pTop + this.mTranslateY);
			drawChild(canvas, this.mPinnedSection.view, getDrawingTime());

			if (this.mShadowDrawable != null && mSectionsDistanceY > 0) {
                this.mShadowDrawable.setBounds(this.mPinnedSection.view.getLeft(),
                        this.mPinnedSection.view.getBottom(),
                        this.mPinnedSection.view.getRight(),
                        this.mPinnedSection.view.getBottom() + mShadowHeight);
    ...
    public boolean dispatchTouchEvent(MotionEvent ev) {
        ...
        if (action == MotionEvent.ACTION_DOWN
                ...
                && this.mPinnedSection != null
                && isPinnedViewTouched(this.mPinnedSection.view, x, y)) { // create touch target
        ...
        if (this.mTouchTarget != null) {
            if (isPinnedViewTouched(this.mTouchTarget, x, y)) { // forward event to pinned view
            ...
            if (action == MotionEvent.ACTION_UP) { // perform onClick on pinned view
                ...
                if (Math.abs(y - this.mTouchPoint.y) > this.mTouchSlop) {
    ...
    private boolean isPinnedViewTouched(View view, float x, float y) {
        ...
        this.mTouchRect.top += mTranslateY;

        this.mTouchRect.bottom += mTranslateY + getPaddingTop();
    ...
    private boolean performPinnedItemClick() {
        if (this.mPinnedSection == null) return false;
